...
client.on('ready', () => {
    ...
    console.log(`----------------`);
  client.user.setGame(` ●『 PP-Community-RP 』● `,"https://twitch.tv/")
...
client.on('message', message => {
    if(message.channel.type === 'dm') {
        var guildID = '504489787764244480'; // <=============== ايدي السيرفر حقك
...
client.on('guildMemberAdd', member => {
    ...
    client.channels.get('515651471618998272').setName(`⟫『 ${memberCount} عدد الاعضاء 』⟪`);
    client.channels.get('515651487112626186').setName(`⟫『 ${botCount} عدد البوتات 』⟪`);
});
...
client.on ("guildMemberAdd", member => {
   ...
   var role = member.guild.roles.find ("name", "•|~ PPC Gold Members ~|•");
   member.addRole (role);
